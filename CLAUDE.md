...
Storage Phase 1 (ปัจจุบัน): IndexedDB ผ่าน 04-storage.js เท่านั้น
Storage Phase 2 (planned): Supabase
...
## Thai Conventions
- วันที่ใช้ พ.ศ. (BE) เสมอ — ใช้ parseBE() / fmtBE() ใน 08-helpers.js
...
## ก่อนแก้ code ทุกครั้ง บอกก่อนว่า
