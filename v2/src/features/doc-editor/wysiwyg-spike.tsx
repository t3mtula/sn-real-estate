...
const INITIAL_VALUE: Value = [
  ...
  },
  {
    ...
    children: [
      {
        text: 'ลองพิมพ์/แก้ข้อความตรงนี้ได้เลย แล้วกดปุ่มบนแถบเครื่องมือ — ทำหัวข้อ ตัวหนา สี ไฮไลต์ จัดแนว เยื้องย่อหน้า ระยะบรรทัด รายการเลข/จุด และแทรกตาราง (กดในตารางจะมีเมนูเพิ่ม/ลบแถว-คอลัมน์)',
      },
    ],
  },
]
