import { ArrowLeft, Building2, MapPin, Pencil, Ruler, ScrollText, Users } from "lucide-react"
      ...
      <div className="flex flex-col gap-4">
        ...
        <Card>
          ...
          <CardContent className="text-sm text-muted-foreground">
            ทรัพย์สิน ID <code className="rounded bg-muted px-1.5 py-0.5">{id}</code> ไม่มีในระบบ
          </CardContent>
        </Card>
      </div>
    )
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="text-2xl font-semibold tracking-tight">{getPropertyName(p)}</h1>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              ID: <code className="rounded bg-muted px-1.5 py-0.5">{property.id}</code>
            </p>
          </div>
        </div>
        <Button asChild>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="grid gap-5 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              <InfoRow icon={ScrollText} label="เลขโฉนด / รายละเอียดที่ดิน" value={p.titleDeed} />
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="lg:col-span-3">
          <CardHeader>
            <CardTitle className="text-base">รูปภาพ ({p.images?.length ?? 0})</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="text-sm text-muted-foreground">
            <p>
              ...
              <span className="font-medium text-foreground">Phase 1B</span> · ตอนนี้ยังไม่ build
              feature สัญญา
            </p>
          </CardContent>
        </Card>
